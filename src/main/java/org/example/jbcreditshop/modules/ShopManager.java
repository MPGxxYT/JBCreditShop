...
import org.example.jbcreditshop.menus.AutoStyleMenu;
import org.example.jbcreditshop.menus.CustomStyleMenu;
import org.example.jbcreditshop.utils.ItemStackHelper;
import org.example.jbcreditshop.yaml.ShopsYaml;
...
public class ShopManager {
  ...
  public ItemStack getShopMenuStack(Shop shop) {
    ...
    builder.addLore("").addLore("&7 ( click to view shop )");
